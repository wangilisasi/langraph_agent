...
SYSTEM_PROMPT = SystemMessage(
    content=(
        ...
        "- Use run_python_code to perform calculations, analyze local data files, or write scripts.\n"
        "- Use run_terminal_command to interact with the OS (e.g. running dir, system checks, checking git status).\n"
        "- Use search_local_documents when the user asks about their own private files, documents, or context.\n"
